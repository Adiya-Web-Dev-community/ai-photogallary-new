  ...
  useEffect(() => {
    const fetchRandomImages = async () => {
      try {
        ...
        ); // Fetching random images from Lorem Picsum
    ...
    <div className="">
      <div className="image-container relative grid grid-cols-3 items-center  gap-4 mx-24">
        {imageData.map((image, index) => (
          <div
            ...
            style={{ margin: "3px", height: "236.7px", width: "355px" }}
          >
            <img
              ...
              >
                <div className="relative flex justify-between sm:justify-end items-center">
                  <span
                    ...
                    title="Share photo"
                    onClick={() => handleShareClick(image.download_url)}
                  >
                    <svg
      ...
      {modalVisible && (
        <div className="modal" onClick={closeModal}>
          ...
          <div
            className="modal-content rounded-xl overflow-hidden"
